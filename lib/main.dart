    ...
    return Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            ...
            locationCard('Random Location', Colors.deepOrangeAccent,
                kenyaFlagUrl, 'Kenya'),

            SizedBox(height: 20),

            locationCard(
                'Select Location', Colors.orange, ugandaFlagUrl, 'Uganda'),
          ],
        ));
  }
}
  ...
  return ClipPath(
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          _topRow(),
          Text('BLAIRTECH VPN', style: vpnStyle),
          _bottomRow(),
        ],
      ),
    ),
            ...
            child: Container(
              ...
              child: Center(
                child: Container(
                  ...
                  child: Center(
                    child:
                        Icon(Icons.wifi_lock, color: Colors.orange, size: 50),
                  ),
                ),
              ),
            ),
